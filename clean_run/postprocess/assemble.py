    ...
    *,
    ...
    return {
        ...
        "route_data": {
            ...
            "geometry_point_count": recommended.get("geometry_point_count", 0),
            "geometry_distance_m": recommended.get("geometry_distance_m", 0.0),
            "sampled_points": recommended.get("sampled_points", []),
